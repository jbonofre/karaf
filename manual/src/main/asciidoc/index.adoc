...
[NOTE]
====
The developer guide is currently under a refactoring. 
You can find most of the developer guide topic in the examples folder
of the Karaf standard distribution.
====
